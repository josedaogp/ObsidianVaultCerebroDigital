https://n8n.io/workflows/4723-ai-personal-assistant/
...
n8n url:
```
https://primary-production-ede4.up.railway.app/home/workflows
```
joseda.ortiz@gmail.com
622112231J.d
evolution api url:
```
https://evolution-api-production-cc65.up.railway.app/manager/
```
api-key evolution-api:
```
106dfb78-2e6e-495b-b80b-f501c63bb84f
```

redis: PONER SIN COMILLAS EN RAILWAY
```
${{ Redis.REDIS_URL }}
```

postgres: PONER SIN COMILLAS EN RAILWAY
```
